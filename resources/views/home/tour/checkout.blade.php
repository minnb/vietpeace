			...
			<div class="row">
							...
							<tr>
								...
								<td>
									<div class="numbers-row">
										<input type="text" value="{{$item->quantity}}" id="quantity_1" class="qty2 form-control" name="quantity_1">
									</div>
								</td>
								<td>
									0%
				...
				<aside class="col-lg-4">
					<div class="box_style_1">
						...
						<a class="btn_full" href="{{ route('index.tour.payment.get') }}">Book now</a>
