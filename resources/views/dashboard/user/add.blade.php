...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="{{route('post.dashboard.user.add')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <select name="role" class="col-xs-10 col-sm-5">
                                    {!! getSelectForm(App\Models\Role::getRoleSelect(), 3) !!}
                                </select>
                            </div>
                        </div>
                    </div>
