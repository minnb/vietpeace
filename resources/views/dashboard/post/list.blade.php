        ...
        <div class="col-xs-12">
            <div class="tabbable">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li>
                        <a href="{{route('get.dashboard.post.add')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="{{ route('get.dashboard.post.edit', ['id'=>fencrypt($item->id)])}}">
                                                    <i class="ace-icon fa fa-pencil-square-o bigger-130"></i> Edit
                                                </a>&nbsp; &nbsp; 
                                                <a class="red" href="{{ route('get.dashboard.post.del', ['id'=>fencrypt($item->id)])}}" onclick="return alertDelete();">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                <div class="inline pos-rel">
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                        ...
                                                        <li>
                                                            <a href="{{ route('get.dashboard.post.del', ['id'=>fencrypt($item->id)])}}" onclick="return alertDelete();">
                                                                <span class="red">
