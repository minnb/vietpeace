...
@section('page_header', 'Add Function')
@section('stylesheet')  
...
<div class="page-content">
    <div class="row">
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="{{route('post.dashboard.function.add')}}" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="<?php echo csrf_token() ?>">
            <div class="tabbable">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active">
                        <a data-toggle="tab" href="#addUser">
                            <i class="red ace-icon fa fa-home bigger-120"></i> Add Function
                        </a>
                    </li>
                    <li>
                ...
                <div class="tab-content">
                    <div id="addFunction" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="url" required="" value="{{ old('url','#') }}" placeholder="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-xs-2 control-label no-padding-right" for="form-field-1"> Param </label>
                            <div class="col-xs-10">
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="param" value="{{ old('param','') }}" placeholder="" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <select name="parent" class="col-xs-10 col-sm-5">
                                    ...
                                    {!! getSelectForm(App\Models\Functions::getParentFunction(), old('parent', 0)) !!}
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="number" id="form-field-1" class="col-xs-10 col-sm-5" name="sort" required="" value="{{ old('sort',0) }}" style="text-align: center;" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name="classCss" value="{{ old('classCss','') }}" />
                            </div>
                        </div>
                        <div class="form-group">
