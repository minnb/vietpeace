...
@section('page_header', 'Unlock & Block 40')
@section('stylesheet')  
...
<div class="page-content">
    ...
    <div class="row">
        {{ $queryString }}
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" action="{{ route('post.master.un_block40.import', ['token'=>$token])}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="clearfix form-actions">
        <div class="col-md-offset-3 col-md-9">
            <form class="form-horizontal" role="form" action="{{ route('post.master.un_block40', ['token'=>$token])}}" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo csrf_token() ?>">
                ...
                &nbsp; &nbsp; &nbsp;
                <a class="btn btn-white btn-danger btn-bold" href="{{route('get.master.reset.ub40', ['token'=>$token])}}">
